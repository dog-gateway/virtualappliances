        ...
        implements MicrowaveOven
{
    ...
    private void initializeStates()
    {
        ...
        this.currentState.setState(MicrowaveEmissionState.class.getSimpleName(),
                new MicrowaveEmissionState(
                        new NotEmittingMicrowavesStateValue()));
    ...
    {
        ((MicrowaveOven) this.device).notifyNewEvent(event, sensorId);
    ...
    {
        ((MicrowaveOven) this.device).notifyNewAlert(alertId, alert);
    }
