		...
		implements WashingMachine
{
	 ...
	 * @see
	 * it.polito.elite.dog.core.library.model.devicecategory.WashingMachine#
	 * notifyNewEventSet(java.lang.Object[])
	 */
	@Override
	public void notifyNewEventSet(Object[] events)
	{
		((WashingMachine) this.device).notifyNewEventSet(events);
	}
	 ...
	 * @see
	 * it.polito.elite.dog.core.library.model.devicecategory.WashingMachine#
	 * notifyNewAlertSet(java.lang.Object[])
	 */
	@Override
	public void notifyNewAlertSet(Object[] alerts)
	{
		((WashingMachine) this.device).notifyNewAlertSet(alerts);
	}
